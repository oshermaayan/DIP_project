...
def get_net(input_depth, NET_TYPE, pad, upsample_mode,
            add_reg_noise, n_channels=3, act_fun='LeakyReLU', skip_n33d=128, skip_n33u=128,
    ...
    if NET_TYPE == 'ResNet':
        ...
        net = skip(input_depth, n_channels, num_channels_down = [skip_n33d]*num_scales if isinstance(skip_n33d, int) else skip_n33d,
                                            ...
                                            upsample_mode=upsample_mode, add_reg_noise=add_reg_noise,
        ...
        ### TODO ??? add net.apply(init_weights) here
        ### TODO add init_weights function(s)
